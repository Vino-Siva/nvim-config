-- NOTE: the leader key is set in options.lua, which is required before this file.
...
-- Open a small custom terminal
vim.keymap.set(
  "n",
  "<leader>ot",
  function() -- Press 'i' to go into terminal mode. Press <C-d> to kill the terminal in 'Terminal' mode.
    vim.cmd.vnew()
    vim.cmd.term()
    vim.cmd.wincmd("J")
